...
title: Enabling Syntax Highlighting for WebC in NeoVim
date: 2023-03-06
image:
    src: JcIsWebC
...
summary: Tired of looking at plain WebC files with no syntax highlighting in NeoVim. You don't have to do that anymore.
tags: ['NeoVim', 'WebC']
draft: false
---
...
<Code fileName="treesitter-config.lua" lineNumber={1}>
```lua
vim.filetype.add({
    extension = {
        webc = 'webc'
...
<Code fileName="treesitter-config.lua" lineNumber="7">
```lua
